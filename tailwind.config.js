...
function App() {
  ...
  return (
    <div className={darkMode ? 'dark' : ''}>
      <div className="min-h-screen bg-white dark:bg-charcoal-navy transition-colors duration-300">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-white/90 dark:bg-deep-blue-gray/90 backdrop-blur-md border-b border-gray-200 dark:border-slate-graphite">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-slate-graphite rounded-lg flex items-center justify-center">
                <Brain className="w-5 h-5 text-ivory" />
              </div>
              <span className="text-xl font-bold text-charcoal-navy dark:text-ivory">Expense IQ</span>
            </div>
          
            <div className="hidden sm:flex items-center space-x-6">
              <a href="#features" className="text-gray-600 dark:text-warm-gray hover:text-charcoal-navy dark:hover:text-ivory transition-colors">Features</a>
              <a href="#pricing" className="text-gray-600 dark:text-warm-gray hover:text-charcoal-navy dark:hover:text-ivory transition-colors">Pricing</a>
              <button
                onClick={() => setDarkMode(!darkMode)}
                className="p-2 rounded-lg bg-gray-100 dark:bg-slate-graphite hover:bg-gray-200 dark:hover:bg-slate-graphite/80 transition-colors"
                aria-label={`Switch to ${darkMode ? 'light' : 'dark'} mode`}
              >
                {darkMode ? <Sun className="w-4 h-4 text-ivory" /> : <Moon className="w-4 h-4 text-charcoal-navy" />}
              </button>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-brand-text-dark dark:text-brand-text-light mb-4 sm:mb-6 leading-tight">
              Stop Drowning in
              <span className="text-charcoal-navy dark:text-ivory block">
                Expense Receipts
              </span>
            </h1>
            
            <p className="text-lg sm:text-xl md:text-2xl text-gray-600 dark:text-warm-gray mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-2">
              AI-powered expense management that automatically captures, categorizes, and consolidates your business expenses across all accounts. Save 10+ hours every month.
            </p>
            ...
            <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-8 items-center justify-center text-sm mb-6 sm:mb-0">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-600 dark:text-warm-gray">No credit card required</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-gray-600 dark:text-warm-gray">14-day free trial</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-gray-600 dark:text-warm-gray">Cancel anytime</span>
              </div>
            </div>
            
               {/* Social Proof Badge - Moved to bottom of hero */}
            <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center space-x-2 bg-gray-100 dark:bg-slate-graphite border border-gray-200 dark:border-slate-graphite rounded-full px-4 py-2 mb-6 sm:mb-8">
