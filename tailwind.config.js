...
<div className={darkMode ? 'dark' : ''}>
  <div className="min-h-screen bg-ivory dark:bg-charcoal-navy transition-colors duration-300">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-ivory/90 dark:bg-deep-blue-gray/90 backdrop-blur-md border-b border-warm-gray/20 dark:border-slate-graphite/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              <div className="w-8 h-8 bg-charcoal-navy dark:bg-ivory rounded-lg flex items-center justify-center">
                <Brain className="w-5 h-5 text-ivory dark:text-charcoal-navy" />
              </div>
              <span className="text-xl font-bold text-charcoal-navy dark:text-ivory">Expense IQ</span>
            </div>
          
            <div className="hidden sm:flex items-center space-x-6">
              <a href="#features" className="text-warm-gray dark:text-warm-gray hover:text-charcoal-navy dark:hover:text-ivory transition-colors">Features</a>
              <a href="#pricing" className="text-warm-gray dark:text-warm-gray hover:text-charcoal-navy dark:hover:text-ivory transition-colors">Pricing</a>
              <button
                onClick={() => setDarkMode(!darkMode)}
                className="p-2 rounded-lg bg-warm-gray/20 dark:bg-slate-graphite/50 hover:bg-warm-gray/30 dark:hover:bg-slate-graphite/70 transition-colors"
