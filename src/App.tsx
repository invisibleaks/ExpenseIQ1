        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg sm:text-xl md:text-2xl text-gray-700 dark:text-gray-200 mb-6 sm:mb-8 max-w-3xl mx-auto leading-relaxed px-2">
              <span className="text-gray-900 dark:text-white">AI-powered expense management that automatically captures, categorizes, and consolidates your business expenses across all accounts.</span>
            ...
            <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-8 items-center justify-center text-sm mb-6 sm:mb-0">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-800 dark:text-gray-100">No credit card required</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-gray-800 dark:text-gray-100">14-day free trial</span>
              </div>
              <div className="flex items-center space-x-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span className="text-gray-800 dark:text-gray-100">Cancel anytime</span>
              </div>
            </div>
            ...
            <div className="mt-6 sm:mt-8 flex flex-wrap items-center justify-center space-x-2 bg-gradient-to-r from-purple-600/10 to-cyan-500/10 border border-purple-500/20 rounded-full px-4 py-2 mb-6 sm:mb-8">
              ...
              <span className="text-sm text-gray-800 dark:text-gray-100 text-center">Trusted by 15,000+ entrepreneurs</span>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent to-purple-50/50 dark:to-slate-800/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-800 dark:text-gray-100 max-w-2xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border-2 border-dashed border-purple-300 dark:border-purple-500/50 rounded-xl p-6 sm:p-8 text-center hover:border-purple-500 transition-colors cursor-pointer">
                      ...
                      <p className="text-gray-800 dark:text-gray-100 mb-2">Drop receipts here or click to upload</p>
                      <p className="text-sm text-gray-700 dark:text-gray-200">Supports photos, PDFs, emails, and bank connections</p>
                    </div>
                        ...
                        <div key={index} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-slate-700 rounded-lg">
                          <div className="flex items-center space-x-3">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-gray-700 dark:text-gray-200">{item.category}</p>
                            </div>
                          </div>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-cyan-50 dark:from-slate-700 dark:to-slate-600 p-6 rounded-xl">
                      <div className="grid grid-cols-2 gap-4 mb-6">
                        <div className="text-center">
                          ...
                          <p className="text-sm text-gray-800 dark:text-gray-100">Total Expenses</p>
                        </div>
                        <div className="text-center">
                          <p className="text-2xl font-bold text-cyan-500 dark:text-cyan-400">127</p>
                          <p className="text-sm text-gray-800 dark:text-gray-100">Receipts Processed</p>
                        </div>
                      </div>
                      ...
                      <div className="space-y-2">
                        {[
                          ...
                          <div key={index} className="flex items-center space-x-3">
                            <div className="w-16 sm:w-20 text-sm text-gray-800 dark:text-gray-100">{item.category}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="group bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-700 hover:shadow-xl hover:scale-105 transition-all duration-300">
                ...
                <p className="text-gray-800 dark:text-gray-100 mb-4 leading-relaxed">{benefit.description}</p>
            ...
            {[
              ...
              <div key={index} className="relative">
                ...
                <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-700 relative z-10">
                  ...
                  <p className="text-gray-800 dark:text-gray-100 text-sm leading-relaxed">{step.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg sm:text-xl text-gray-800 dark:text-gray-100 px-4">
              ...
              <div key={index} className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-700">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-800 dark:text-gray-100">{testimonial.role}</p>
              ...
              <div key={index} className="bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-2xl overflow-hidden">
                ...
                {openFaq === index && (
                  <div className="px-6 pb-6">
                    <p className="text-gray-800 dark:text-gray-100 leading-relaxed">{faq.answer}</p>
                  </div>
                )}
              </div>
            ))}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-purple-900 to-slate-900 dark:from-purple-800 dark:to-slate-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col space-y-2 sm:flex-row sm:space-y-0 sm:space-x-8 items-center justify-center text-purple-100">
            ...
            <div className="flex items-center space-x-2">
              <CheckCircle className="w-4 h-4 text-cyan-400" />
              <span className="text-purple-100">$3,200 average savings</span>
            </div>
            <div className="flex items-center space-x-2">
              <CheckCircle className="w-4 h-4 text-cyan-400" />
              <span className="text-purple-100">10+ hours saved monthly</span>
            </div>
          </div>
        </div>
      </section>
